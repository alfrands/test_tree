...
@Entity
@Table(name = "oasloga_log")
@EntityListeners(AuditingEntityListener.class)
public class LogServiceOaslogA implements Serializable {
    @Id
    ...
    public LogServiceOaslogA() {
    }

    public LogServiceOaslogA(String request_address, String cardNumber, String localDateTime, String request) {
