...
@Entity
@Table(name = "icl_service_log")
@EntityListeners(AuditingEntityListener.class)
public class LogServiceIcl implements Serializable {
    ...
    public LogServiceIcl() {
    }

    public LogServiceIcl(String request_address, String trxId, String localDateTime, String request) {
