...
@Entity
@Table(name = "card_block_log")
@EntityListeners(AuditingEntityListener.class)
public class LogServiceCardBlock implements Serializable {
    ...
    public LogServiceCardBlock() {
    }

    public LogServiceCardBlock(String request_address, String trxId, String localDateTime, String request) {
