...
@Entity
@Table(name = "edclogb_log")
@EntityListeners(AuditingEntityListener.class)
public class LogServiceEdclogB implements Serializable {
    @Id
    ...
    public LogServiceEdclogB() {
    }

    public LogServiceEdclogB(String request_address, String terminalId, String localDateTime, String request) {
