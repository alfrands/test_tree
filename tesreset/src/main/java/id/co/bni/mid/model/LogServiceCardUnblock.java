...
@Entity
@Table(name = "card_unblock_log")
@EntityListeners(AuditingEntityListener.class)
public class LogServiceCardUnblock implements Serializable {
    ...
    public LogServiceCardUnblock() {
    }

    public LogServiceCardUnblock(String request_address, String trxId, String localDateTime, String request) {
