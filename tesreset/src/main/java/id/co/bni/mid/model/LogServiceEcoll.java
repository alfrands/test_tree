...
@Entity
@Table(name = "ecoll_service_log")
@EntityListeners(AuditingEntityListener.class)
public class LogServiceEcoll implements Serializable {
    ...
    public LogServiceEcoll() {
    }

    public LogServiceEcoll(String request_address, String trxId, String service, String localDateTime, String request) {
