...
@Entity
@Table(name = "oaai_service_log")
@EntityListeners(AuditingEntityListener.class)
public class LogServiceOaai implements Serializable {
    ...
    public LogServiceOaai() {
    }

    public LogServiceOaai(String request_address, String trxId, String localDateTime, String request) {
