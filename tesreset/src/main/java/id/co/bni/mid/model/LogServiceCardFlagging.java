...
@Entity
@Table(name = "card_flagging_log")
@EntityListeners(AuditingEntityListener.class)
public class LogServiceCardFlagging implements Serializable {
    ...
    public LogServiceCardFlagging() {
    }

    public LogServiceCardFlagging(String request_address, String trxId, String localDateTime, String request) {
