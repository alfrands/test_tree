...
@Entity
@Table(name = "validate_service_log")
@EntityListeners(AuditingEntityListener.class)
public class LogServiceValidate implements Serializable {
    ...
    public LogServiceValidate() {
    }

    public LogServiceValidate(String request_address, String trxId, String localDateTime, String request) {
