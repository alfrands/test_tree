...
@Entity
@Table(name = "transactioncc_service_log")
@EntityListeners(AuditingEntityListener.class)
public class LogServiceTransCC implements Serializable {
    ...
    public LogServiceTransCC() {
    }

    public LogServiceTransCC(String request_address, String channelID, String trxId, String localDateTime, String request) {
