...
@Entity
@Table(name = "oaslogb_log")
@EntityListeners(AuditingEntityListener.class)
public class LogServiceOaslogB implements Serializable {
    @Id
    ...
    public LogServiceOaslogB() {
    }

    public LogServiceOaslogB(String request_address, String cardNumber, String localDateTime, String request) {
