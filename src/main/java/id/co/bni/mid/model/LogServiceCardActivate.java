...
@Entity
@Table(name = "card_activate_log")
@EntityListeners(AuditingEntityListener.class)
public class LogServiceCardActivate implements Serializable {
    ...
    public LogServiceCardActivate() {
    }

    public LogServiceCardActivate(String request_address, String trxId, String localDateTime, String request) {
