...
@Entity
@Table(name = "inquiry_service_log")
@EntityListeners(AuditingEntityListener.class)
public class LogServiceInquiry implements Serializable {
    ...
    public LogServiceInquiry() {
    }

    public LogServiceInquiry(String request_address, String trxId, String localDateTime, String request) {
